...
onMounted(() => {
  ...
  function main() {
    ...
    // Fragment shader program - 片段着色器程序
    const fsSource = `
      void main() {
  ...
  function loadShader(gl: WebGLRenderingContext, type, source) {
    ...
    // Send the source to the shader object - 将source传递给shader对象
    gl.shaderSource(shader, source)

    // Compile the shader program - 编译shader
...
<template lang="pug">
canvas#c1(width="600" height="400" style="width: 600px; height: 400px")
</template>
